...
describe("The register box", () => {
  ...
  it("renders the mobile challenge form if the state is confirm mobile", () => {
    ...
    expect(screen.queryByText("Signup was successful. To verify your phone number, please enter the code that was sent to your phone in the box below:")).toBeInTheDocument()
  })
});
