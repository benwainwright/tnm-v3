...
describe("dynamodb data service", () => {
  ...
  describe("the delete method", () => {
    it("should call transactUpdate with the correct params", async () => {
      ...
      AWSMock.mock('DynamoDB.DocumentClient', "transactWrite", (params: AWS.DynamoDB.DocumentClient.TransactWriteItemsInput, callback: (error: AWSError | null, output: AWS.DynamoDB.DocumentClient.TransactWriteItemsOutput) => Request<AWS.DynamoDB.DocumentClient.TransactWriteItemsOutput, AWSError>) => {
