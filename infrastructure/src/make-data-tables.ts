...
const makeTable = (context: Construct, name: string, env: string, transient: boolean) => 
...
export const makeDataTables = (context: Construct, transient: boolean, envName: string) => {
